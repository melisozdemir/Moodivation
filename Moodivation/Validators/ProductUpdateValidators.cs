...
{
    public class ProductUpdateValidators : AbstractValidator<ProductUpdateDto>
    {
        public ProductUpdateValidators()
        {
            RuleFor(c => c.Id).NotEmpty().WithMessage("Enter product id");
